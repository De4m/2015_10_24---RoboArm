...
int PIN[SERVOS], value[SERVOS], idle[SERVOS], currentAngle[SERVOS], MIN[SERVOS], MAX[SERVOS], INITANGLE[SERVOS], previousAngle[SERVOS];
...
//  display.println("Else");
 // display.println("Joysticks Enabled");
//  display.display(); // show splashscreen
  delay(5000);
